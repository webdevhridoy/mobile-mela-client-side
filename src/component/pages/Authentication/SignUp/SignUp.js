    ...
    return (
        <div className="flex items-center justify-center text-center h-screen">
            <form onSubmit={handleSubmit(handleSignUp)} noValidate="" action="" className="flex flex-col w-full max-w-lg p-12 rounded shadow-lg ng-untouched ng-pristine ng-valid  bg-black text-white">
                ...
                <label htmlFor="password" className="self-start mt-3 text-xsfont-semibold">Photo URl</label>
                <input {...register('photoURL')} className="flex items-center h-12 text-black px-4 mt-2 rounded focus:outline-none focus:ring-2" />
